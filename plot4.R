...
#plot voltage chart
plot(datetime,power_data$Voltage , type="l", xlab="datetime", ylab="Voltage")
#plot Energy sub metering Chart
...
#plot reactive power chart
plot(datetime, power_data$Global_reactive_power, type="l", xlab="", ylab="Global_reactive_power")
dev.off()